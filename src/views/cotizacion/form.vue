  ...
  <div class="container">
		...
		<b-form @submit.stop.prevent="submit">
	      <div class="row">
            <div class="col-sm-12 col-lg-6">
			  <strong><label for="price">Cliente:</label></strong>
			  <b-form-group 
			  ...
			  >
			    ...
			    <div class="d-table-cell align-middle ml-1">
				  <b-button id="popover-reactive-1" ref="button" pill size="sm"><i class="fa fa-user-plus"></i></b-button>
				</div>
				<b-popover
    ...
    >
      ...
      <div>
        ...
        <b-button @click="onOk" size="sm" variant="secondary" squared><i class="fa fa-minus-circle"></i></b-button>
      </div>
    </b-popover>
              </b-form-group>
            </div>
		  ...
		  <!-- <div class="row">
		    <div class="form-group col-sm-12 col-lg-6">
	          <strong><label for="price">Atiende:</label></strong>
			  <input type="text" v-model="quotation.attends" class="form-control">
	        </div>
		    <div class="form-group col-sm-12 col-lg-6">
	          <strong><label for="price">Teléfono:</label></strong>
			  <input type="text" class="form-control">
	        </div>
	      </div>
		  <div class="row">
		    <div class="form-group col-sm-12 col-lg-6">
	          <strong><label for="price">E-mail:</label></strong>
			  <input type="text" class="form-control">
	        </div>
		    <div class="form-group col-sm-12 col-lg-6">
	          <strong><label for="price">Dirección:</label></strong>
			  <input type="text" class="form-control">
	        </div>
	      </div> -->
  ...
  export default {
    ...
    methods: {
      ...
      search:_.debounce(async (loading, search, vm) => {
        try {
          const customers = await CustomerService.searchCustomer(`search-customer?name=${search}`)
